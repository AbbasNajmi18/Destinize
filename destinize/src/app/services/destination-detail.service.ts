...
export class DestinationDetailService {
  private destinationDetails: Record<number, Partial<DestinationDetail>> = DESTINATION_DETAILS;
  ...
  private createDefaultDetailedDestination(baseDestination: any): DestinationDetail {
    return {
      ...baseDestination,
      ...
      geography: {
        ...
        landmarks: [`${baseDestination.name} landmarks`, 'Local natural features'],
