...
export const DESTINATION_DETAILS: Record<number, Partial<DestinationDetail>> = {
  ...
  1: {
    ...
    attractions: [
      ...
      },
      {
        name: 'Louvre Museum',
        description:
          "The world's largest art museum, home to thousands of works including the Mona Lisa.",
        image:
          'https://images.unsplash.com/photo-1565099824688-e0ec07a2fe65?q=80&w=1000&auto=format&fit=crop',
        rating: 4.8,
      ...
      },
      {
        ...
        description:
          'A medieval Catholic cathedral known for its French Gothic architecture.',
        image:
          'https://images.unsplash.com/photo-1584666539160-dca1cefd54d9?q=80&w=1000&auto=format&fit=crop',
        rating: 4.7,
    ...
    seasonalInfo: {
      ...
      summer: {
        ...
        activities: [
          'Paris Plages (beach along the Seine)',
          'Open-air cinema',
          'Garden tours',
        ],
        events: [
      ...
      autumn: {
        description:
          'Cooler temperatures with beautiful fall colors in the parks.',
      ...
      winter: {
        description:
          'Cold with occasional snowfall, but magical for the holidays.',
        temperature: '3°C - 8°C',
        activities: [
          'Christmas markets',
          'Ice skating',
    ...
    localCuisine: [
      {
        name: 'Croissant',
        description:
          "Flaky, buttery pastry that's a breakfast staple in France.",
        image:
      ...
      },
      {
        ...
        description:
          'Traditional beef stew slow-cooked with red wine, mushrooms, and herbs.',
        image:
          'https://images.unsplash.com/photo-1584009218463-39f889d4c4e9?q=80&w=1000&auto=format&fit=crop',
        mustTry: true,
      },
    ],
    geography: {
  ...
  2: {
    ...
    attractions: [
      {
        ...
        description:
          'Ancient sea temple perched on a rock formation, especially stunning at sunset.',
        image:
          'https://images.unsplash.com/photo-1518736348021-d69b4c035d4d?q=80&w=1000&auto=format&fit=crop',
        rating: 4.6,
        visitDuration: '1-2 hours',
      ...
      },
      {
        ...
        description:
          'Natural forest reserve and temple complex with over 700 Balinese long-tailed monkeys.',
        image:
          'https://images.unsplash.com/photo-1566427786955-7b3cee6c481a?q=80&w=1000&auto=format&fit=crop',
        rating: 4.3,
        visitDuration: '2-3 hours',
      ...
      },
      {
        ...
        description:
          'Stunning stepped rice paddies demonstrating the traditional Balinese cooperative irrigation system.',
        image:
          'https://images.unsplash.com/photo-1531592937781-344ad608fabf?q=80&w=1000&auto=format&fit=crop',
        rating: 4.5,
        visitDuration: '1-2 hours',
    ...
    seasonalInfo: {
      ...
      winter: {
        description:
          'Wet season with brief heavy rainfall, often followed by sunshine.',
        ...
        events: [
          ...
          'Christmas and New Year celebrations at beach clubs',
        ],
        crowdLevel: 'Low (except during holidays)',
      },
    },
    ...
    localCuisine: [
      {
        name: 'Nasi Goreng',
        description:
          'Indonesian fried rice with sweet soy sauce, typically served with a fried egg on top.',
        image:
      ...
      },
      {
        name: 'Babi Guling',
        description:
          'Balinese roast suckling pig flavored with turmeric and various spices.',
        image:
